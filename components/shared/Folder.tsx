...
import { useFolderState } from "@/lib/hooks/folder/useFolderState"
...
export default function Folder({
  ...
  const papers: (ReactNode | null)[] = items.slice(0, MAX_PAPERS)
  ...
  return (
    <div style={{ transform: `scale(${size})` }} className={className}>
      <div
        className={`group relative transition-all duration-200 ease-in cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-zinc-900 focus-visible:ring-offset-2 ${
